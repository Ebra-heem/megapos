...
<div class="col-md-6">
    <div class="card card-primary card-outline" style="height:80vh;">
        ...
        <div class="card-body" style="overflow-y:scroll;">
            <!--Search field category and product wise-->
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <!--Search Result wise or all products -->
            <div class="col-md-12">
                @if ($products->count() > 0)
                <div id="pds" class="row text-center text-lg-left containerItems">
                    ...
                    <div class="col-md-2 col-md-offset-1" style="margin:0;">
                        <a href="" data-tooltip="tooltip"
                            title="Price : {{ $product->sale_price }} stock : {{ $product->stock }} Unit:{{ $product->unit->unit_conversion }}"
                            data-placement="top" data-unit="{{ $product->unit->unit_conversion }}" id="product-{{ $product->id }}" +
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var html = data.products.map(function (item) {
                        ...
                        var unit_conversion = item.unit.unit_conversion;
                        var image = item.image_path;
                        return `<div class="col-md-2 col-md-offset-1" style="margin:0;"><a href="" id="product"
                           data-tooltip="tooltip" title="Price : ${sale} stock : ${stock} Unit:${unit_conversion}" data-placement="top" data-unit="${ unit_conversion }"
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var html =
                            ...
                            <td style="display: flex;">
                                <input id="qty" style="width: 60% !important;" type="number" name="quantity_pcs[]">
                            </td>
